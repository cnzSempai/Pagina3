<body>
  <main>
    <div class="contain" id="containTerminos">
      <div class="row" id="rowTerminos">
        <div class="col-1">

        </div>
        <div class="col-10" >
          <h1 id="titTerminos" ><u>Términos y Condiciones de Uso</u> </h1>

      <p>


<u><b style="color:#b02238;">INFORMACIÓN RELEVANTE </b>
</u> <br>
<p >
...
<section>
  <h2 id="titLicencia"><b><u>Licencia</u></b></h1><br>
  <p id="parrafo-licencia">"CRISport"  a través de su sitio web concede una licencia para que los usuarios utilicen  los productos que son vendidos en este sitio web de acuerdo a los Términos y Condiciones que se describen en este documento.
  USO NO AUTORIZADO
...
<section>
   <br >  <u> POLÍTICA DE REEMBOLSO Y GARANTÍA</u> <br><br>
  ...
  <br><br> <u>COMPROBACIÓN ANTIFRAUDE</u> <br> <br>

  La compra del cliente puede ser aplazada para la comprobación antifraude. También puede ser suspendida por más tiempo para una investigación más rigurosa, para evitar transacciones fraudulentas.
  <br><br><u>PRIVACIDAD</u> <br> <br>

  Este sitio web http://localhost/Pagina3/ garantiza que la información personal que usted envía cuenta con la seguridad necesaria. Los datos ingresados por usuario o en el caso de requerir una validación de los pedidos no serán entregados a terceros, salvo que deba ser revelada en cumplimiento a una orden judicial o requerimientos legales.
  La suscripción a boletines de correos electrónicos publicitarios es voluntaria y podría ser seleccionada al momento de crear su cuenta.
  "CRISport" reserva los derechos de cambiar o de modificar estos términos sin previo aviso.
